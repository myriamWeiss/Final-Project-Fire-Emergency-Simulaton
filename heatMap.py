...
def get_heatmap_for_queu(data, score_string, cmap_name="YlGn", title = "Queue size Heatmap", title_color_bar ="Queue size"):
    norm = Normalize(vmin=0, vmax=1)
    return build_heatmap_from_csv_win(data, norm, score_string, cmap_name, title, title_color_bar,truncate_range=(0.2, 1))

def get_heatmap_for_wins_percentage(data, score_string, cmap_name="autumn", title = "Win Percentage Heatmap", title_color_bar ="Win Percentage"):
